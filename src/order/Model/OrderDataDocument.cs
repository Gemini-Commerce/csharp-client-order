...
namespace order.Model
{
    ...
    /// OrderDataDocument
    /// </summary>
    [DataContract(Name = "OrderDataDocument")]
    public partial class OrderDataDocument : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OrderDataDocument" /> class.
        /// </summary>
        /// <param name="code">code.</param>
        /// <param name="label">label.</param>
        /// <param name="assetGrn">assetGrn.</param>
        /// <param name="url">url.</param>
        public OrderDataDocument(string code = default(string), string label = default(string), string assetGrn = default(string), string url = default(string))
        {
            this.Code = code;
            this.Label = label;
