...
namespace order.Model
{
    ...
    /// OrderMoney
    /// </summary>
    [DataContract(Name = "orderMoney")]
    public partial class OrderMoney : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OrderMoney" /> class.
        /// </summary>
        ...
        public OrderMoney(string units = default(string), int micros = default(int))
        {
            this.Units = units;
            this.Micros = micros;
        }
