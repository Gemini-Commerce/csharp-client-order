...
namespace order.Model
{
    ...
    /// </summary>
    [DataContract(Name = "orderCancelOrderRequest")]
    public partial class OrderCancelOrderRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OrderCancelOrderRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected OrderCancelOrderRequest()
        {
        ...
        public OrderCancelOrderRequest(string tenantId = default(string), string orderId = default(string), string reason = default(string), CancelOrderRequestBehaviorOptions options = default(CancelOrderRequestBehaviorOptions))
        {
            ...
            if (tenantId == null)
            {
                throw new ArgumentNullException("tenantId is a required property for OrderCancelOrderRequest and cannot be null");
            }
            this.TenantId = tenantId;
            // to ensure "orderId" is required (not null)
            if (orderId == null)
            {
                throw new ArgumentNullException("orderId is a required property for OrderCancelOrderRequest and cannot be null");
            }
