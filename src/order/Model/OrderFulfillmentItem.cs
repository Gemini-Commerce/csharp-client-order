...
namespace order.Model
{
    ...
    /// </summary>
    [DataContract(Name = "orderFulfillmentItem")]
    public partial class OrderFulfillmentItem : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OrderFulfillmentItem" /> class.
        /// </summary>
        /// <param name="orderItemId">orderItemId.</param>
        /// <param name="qty">qty.</param>
        public OrderFulfillmentItem(string orderItemId = default(string), long qty = default(long))
        {
