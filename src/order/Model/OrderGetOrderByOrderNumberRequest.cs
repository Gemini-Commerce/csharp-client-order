...
namespace order.Model
{
    ...
    public partial class OrderGetOrderByOrderNumberRequest : IValidatableObject
    {
        ...
        protected OrderGetOrderByOrderNumberRequest()
        {
        ...
        public OrderGetOrderByOrderNumberRequest(string tenantId = default(string), string orderNumber = default(string))
        {
            ...
            if (tenantId == null)
            {
                throw new ArgumentNullException("tenantId is a required property for OrderGetOrderByOrderNumberRequest and cannot be null");
            }
            this.TenantId = tenantId;
            // to ensure "orderNumber" is required (not null)
            if (orderNumber == null)
            {
                throw new ArgumentNullException("orderNumber is a required property for OrderGetOrderByOrderNumberRequest and cannot be null");
            }
