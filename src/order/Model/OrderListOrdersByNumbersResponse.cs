...
namespace order.Model
{
    ...
    /// </summary>
    [DataContract(Name = "orderListOrdersByNumbersResponse")]
    public partial class OrderListOrdersByNumbersResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OrderListOrdersByNumbersResponse" /> class.
        /// </summary>
        ...
        public OrderListOrdersByNumbersResponse(List<OrderOrderData> orders = default(List<OrderOrderData>), string nextPageToken = default(string))
        {
            this.Orders = orders;
