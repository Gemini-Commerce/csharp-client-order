...
namespace order.Model
{
    ...
    /// </summary>
    [DataContract(Name = "orderListOrdersByCustomerResponse")]
    public partial class OrderListOrdersByCustomerResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OrderListOrdersByCustomerResponse" /> class.
        /// </summary>
        ...
        public OrderListOrdersByCustomerResponse(List<OrderOrderData> orders = default(List<OrderOrderData>), string nextPageToken = default(string))
        {
            this.Orders = orders;
