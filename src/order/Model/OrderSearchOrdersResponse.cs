...
namespace order.Model
{
    ...
    /// </summary>
    [DataContract(Name = "orderSearchOrdersResponse")]
    public partial class OrderSearchOrdersResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OrderSearchOrdersResponse" /> class.
        /// </summary>
        ...
        public OrderSearchOrdersResponse(List<OrderOrderData> orders = default(List<OrderOrderData>), string nextPageToken = default(string))
        {
            this.Orders = orders;
